...
export function registerFilesystemTools(
  ...
  /** Prepend any not-yet-shown ancestor project rules (between absPath's dir and rootDir) to a read_file body. Outer dirs first so broad rules read before specific overrides. */
  ...
  /** Same idea as withSubdirMemory but for list_directory — includes the listed dir's own project rules, not just ancestors. */
