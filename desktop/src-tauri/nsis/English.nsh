...
LangString appRunning ${LANG_ENGLISH} "Carbon Code is running! Please close it first then try again."
LangString appRunningOkKill ${LANG_ENGLISH} "Carbon Code is running!$\nClick OK to kill it"
...
LangString failedToKillApp ${LANG_ENGLISH} "Failed to kill Carbon Code. Please close it first then try again"
